"""Utility functions for Category-Navigate System"""
...
def validate_config(config: Dict[str, Any]) -> bool:
    ...
    for key in ["chunk_size", "overlap", "boundary_preview_chars", "hierarchy_threshold", 
                "max_title_length", "summary_min_tokens", "summary_max_tokens"]:
